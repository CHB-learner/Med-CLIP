...
if __name__ == "__main__":
    clip = CLIP()
    #
    captions   = ['cancer_classification is Colon adenocarcinoma', 'cancer_classification is Head and Neck squamous cell carcinoma', 'cancer_classification is Lung squamous cell carcinoma', 'cancer_classification is Uterine Corpus Endometrial Carcinoma', 'cancer_classification is Ovarian serous cystadenocarcinoma', 'cancer_classification is Adrenocortical carcinoma', 'cancer_classification is Thyroid carcinoma', 'cancer_classification is Breast invasive carcinoma', 'cancer_classification is Lung adenocarcinoma', 'cancer_classification is Bladder Urothelial Carcinoma', 'cancer_classification is Prostate adenocarcinoma', 'cancer_classification is Kidney renal clear cell carcinoma']

               
    number_one_class = 100
    csv = pd.read_csv('./1_estimate_chb/pubmed_set/{}_test.csv'.format(number_one_class))  # 10_test_test.csv 20_test_test.csv all_test.csv
    tru_lable = []
    predict = []
